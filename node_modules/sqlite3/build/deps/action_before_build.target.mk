...
cmd_deps_sqlite3_gyp_action_before_build_target_unpack_sqlite_dep = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/deps; mkdir -p $(obj)/gen/sqlite-autoconf-3080600; python ./extract.py ./sqlite-autoconf-3080600.tar.gz "$(obj)/gen"

$(obj)/gen/sqlite-autoconf-3080600/sqlite3.c: obj := $(abs_obj)
$(obj)/gen/sqlite-autoconf-3080600/sqlite3.c: builddir := $(abs_builddir)
$(obj)/gen/sqlite-autoconf-3080600/sqlite3.c: TOOLSET := $(TOOLSET)
$(obj)/gen/sqlite-autoconf-3080600/sqlite3.c: $(srcdir)/deps/sqlite-autoconf-3080600.tar.gz FORCE_DO_CMD
	$(call do_cmd,deps_sqlite3_gyp_action_before_build_target_unpack_sqlite_dep)

all_deps += $(obj)/gen/sqlite-autoconf-3080600/sqlite3.c
action_deps_sqlite3_gyp_action_before_build_target_unpack_sqlite_dep_outputs := $(obj)/gen/sqlite-autoconf-3080600/sqlite3.c
